...
from neddf.nn_module.with_grad import SoftplusGradFunction


class TestSoftplusGradFunction:
    def test_Softplus_grad_functino(self):
        # test settings
        batch_size: int = 10
        input_dim: int = 3
        feature_dim: int = 15
        ...
        y, G = SoftplusGradFunction.apply(x, J)
        ...
        for axis in range(3):
            ...
            y2, G2 = SoftplusGradFunction.apply(x+delta_x, J)
